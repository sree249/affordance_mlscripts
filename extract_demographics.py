...
headers = [ 'Random_ID','ResponseId','device_use','Finished','Q20', 'Q1', 'Q1_6_TEXT', 'Q2', 'Q2_4_TEXT', 'Q3', 'Q3_5_TEXT', 'Q4', 'Q4_2_TEXT', 'Q5', 'Q5_5_TEXT', 'Q6', 'Q7',
			...
			'5_Q185','5_Q185_5_TEXT','6_Q185','6_Q185_5_TEXT','scenario','Q37','Q38','Q39','Q40','Q41','Q42'] #"scenario" should be added/removed as per dataset.
'''
...
res_data.to_csv(file_name)
'''
demo_headers = ['Random_ID','ResponseId','Q37','Q38','Q39','Q40','Q41','Q42']
res_data = res_data[res_data['a_checks']==1]
demo_data = res_data[demo_headers]
#rewrite the dataset after removing attention checks
file_name = "Datasets/Demographics/"+dataset+"demographic_details.csv"			
demo_data.to_csv(file_name)
